...
# Run some frames
#./TAppEncoder -c cfg/$current_enc_cfg.cfg -c cfg/per-sequence/$current_cfg.cfg  -i "$sequences_dir"/$current_yuv.yuv -q ${Qp[$i]} -f 23 -b Gen/Seq-265/$current_bs.265 > Gen/Seq-TXT/$current_txt.txt
